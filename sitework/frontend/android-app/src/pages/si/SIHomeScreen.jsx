...
export const SIHomeScreen = ({ user, siProfile, siteWorks, lang, setScreen }) => {
  ...
  const handleRefer = async () => {
    ...
    const text = hi
      ? `मैं SiteMitra use कर रहा हूँ — Client Site के पास CCTV Technician खोजने का free app है। आप भी try करो:\n${url}`
      : `I use SiteMitra — free app to find nearby CCTV technicians for client sites. Try it:\n${url}`;
    if (navigator.share) {
      ...
      <div style={{ padding:"0 16px 24px" }}>
        <button onClick={handleRefer} style={{
          ...
          <div style={{ flex:1 }}>
            ...
            <div style={{ fontSize:12, color:T.muted, marginTop:2 }}>
              {hi ? "WhatsApp पर share करें — ज़्यादा technicians जुड़ेंगे" : "Share on WhatsApp — grow the network"}
            </div>
          </div>
