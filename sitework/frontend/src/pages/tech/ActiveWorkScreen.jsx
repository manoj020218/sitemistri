    ...
    <div>
      <div style={{ padding:"16px 16px 0" }}>
        ...
        {work.clientMobile && (
          <Card style={{ marginBottom:12 }}>
            <div style={{ padding:"14px 16px" }}>
              <div style={{ fontFamily:font.mono, fontSize:10, color:T.muted, letterSpacing:".08em", marginBottom:6 }}>CLIENT</div>
              {work.clientName && <div style={{ fontFamily:font.display, fontSize:15, fontWeight:700, marginBottom:8 }}>{work.clientName}</div>}
              <div style={{ display:"flex", gap:8 }}>
