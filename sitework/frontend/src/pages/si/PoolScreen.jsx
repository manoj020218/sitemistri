...
— SiteMitra | CCTV SI & Technician Platform`;
  ...
  return (
    <div style={{ padding:"16px" }}>
      <button onClick={()=>setScreen("profile")} style={{ display:"flex",alignItems:"center",gap:6,background:"none",border:"none",cursor:"pointer",fontFamily:font.body,fontSize:14,color:T.muted,marginBottom:12,padding:0 }}>
        ← {hi?"वापस":"Back"}
      </button>
